...
DECLARE
  ...
  -- project_url TEXT := 'https://tukglyxjehouopfcxpkz.supabase.co';
  ...
  -- service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR1a2dseXhqZWhvdW9wZmN4cGt6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTk0MzEyOCwiZXhwIjoyMDI1NTE5MTI4fQ.xlF18ku3orSOWg-gr4NttgVkNOL-LpV-gxssakIgEEw'; -- full access needed for http request to storage
